...
# --------- DDC -----------------
    ...
    with threecol2: 
        ...
        htmlstr = f"""<a href="https://portal.dnb.de/opac/simpleSearch?query=catalog%3Ddnb.hss+diss*+location%3Donlinefree+hsg%3D7*&cqlMode=true" target="new" style="text-decoration:none">
                        ...
                        line-height:35px'><b>{i}</b></style></span></p></a>"""
...
# -------------------- ABOUT ---------------------    
    ...
    st.markdown("Für die Übersicht nach Fachgebieten konnten ingesamt 287.271 für die Darstellung berücksichtigt werden. Bei den restlichen 852 "
                "Datensätzen fehlt die Zuordnung zu einem Fachgebiet.") 
